        ...
        <div className="flex-1 flex flex-col items-center justify-center p-2">
          <div className="text-center max-w-6xl">
            ...
            <p className="text-md md:text-lg text-gray-600 mb-8 max-w-4xl mt-12 mx-auto text-center">
              Find your perfect job match with our AI-powered platform that
              analyzes your skills, preferences, and career goals to connect you
            ...
            <div className="border-t border-gray-200 pt-4">
              <div className="text-center">
                ...
                <p className="text-xs text-gray-400">
                  © 2025 Jobmate.agent. All rights reserved. | Powered by AI
                  Technology
                </p>
              </div>
            </div>
